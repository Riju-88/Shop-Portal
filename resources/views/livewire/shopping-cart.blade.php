                    ...
                    <div class="flex flex-col space-y-4 overflow-y-scroll">
                        @if (count($carts) > 0)
                            @foreach ($carts as $index => $cartItem)
                                <div class="flex flex-col md:flex-row items-start md:space-x-4 space-y-4 md:space-y-0 bg-slate-200 border-1 p-4 rounded-xl">
                                    ...
                                    <div class="flex flex-col justify-between flex-grow">
                                        ...
                                        <div class="flex-col justify-between">
                                            <p class="text-lg font-bold">{{ number_format($cartItem['product']['price'] * $cartItem['quantity'], 2) }}</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="border-t border-gray-200 dark:border-zinc-600 py-6 px-4 sm:px-6">
                                ...
                                <div class="flex justify-between mt-4">
                                    <a href="{{ route('checkout') }}" class="btn btn-accent btn-outline mt-4 btn-block ">Checkout</a>
                                </div>
                            </div>
                        @else
