    ...
    <p class="text-gray-600 mb-6">We'd love to hear from you! Whether you have a question about our products, need assistance, or just want to share your feedback, our team is ready to help. Please fill out the form below, and we'll get back to you as soon as possible.</p>
        ...
        <form wire:submit.prevent="submit">
            ...
            <div class="mb-4">
                ...
                <input id="name" type="text" class="input input-bordered mt-1 block w-full rounded-md shadow-sm bg-red-500 border-gray-300" wire:model="name">
    ...
    <div class="bg-white shadow-md rounded-lg px-8 py-8 mb-4 mt-8">
        ...
        <div class="mb-4">
            ...
            <div class="flex space-x-4 mt-2">
                <a href="https://x.com" target="_blank" class="text-blue-500 hover:text-blue-700">
               ...
               <a href="https://youtube.com" target="_blank" class="text-red-500 hover:text-pink-700">
                ...
                <a href="https://facebook.com" target="_blank" class="text-blue-400 hover:text-blue-600">
                ...
                <a href="https://linkedin.com" target="_blank" class="text-blue-600 hover:text-blue-900">
                   
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="26" viewBox="0 0 48 48" class="fill-current">
